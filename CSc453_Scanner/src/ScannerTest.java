...
//    if (result.equals(expected)) {System.out.println("|PLUS: +||NUM: 3||NUM: 3| Passed");};
//
//    result = test.extractTokens("+ - * / < >");
//    expected = "|PLUS: +||MINUS: -||MUL: *||DIV: /||LT: <||GT: >|";
//    if (result.equals(expected)) {System.out.println("|PLUS: +||MINUS: -||MUL: *||DIV: /||LT: <||GT: >| Passed");};
//
//    result = test.extractTokens("<= - >=");
//    expected = "|LTE: <=||MINUS: -||GTE: >=|";
//    if (result.equals(expected)) {System.out.println("|LTE: <=||MINUS: -||GTE: >=| Passed");};
